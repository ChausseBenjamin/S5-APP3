...
d'origine, en quelques fonctions python. L'enveloppe temporelle du signal (\ref{fig:enveloppe-guitar}) est obtenue en
convoluant un filtre passe-bas à moyenne mobile, de type RIF, avec l'absolue du signal 
d'origine. Schéma bloc à cette figure: (\ref{fig:extraction-paramètres})
...
tel quelle. Hors, la fréquence de coupure utilisé pour la guitar est $\pi/1000$. Suffi de tester tout les ordres possibles
...
N choisi de cette façon est $885$. La figure \ref{fig:reponse-frequentielle-rif} montre la réponse fréquentielle
de se filtre et la fréquence à -3dB.